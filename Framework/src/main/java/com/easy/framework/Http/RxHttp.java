...
import com.easy.framework.Http.api.HttpApi;
import com.easy.framework.Http.callback.HttpCallback;
import com.easy.framework.Http.callback.UploadCallback;
import com.easy.framework.Http.cancel.RequestManagerImpl;
import com.easy.framework.Http.load.UploadRequestBody;
import com.easy.framework.Http.observer.HttpObservable;
import com.easy.framework.Http.retrofit.Method;
import com.easy.framework.Http.retrofit.RetrofitUtils;
import com.easy.framework.Http.tools.RequestUtils;
...
public class RxHttp {
    ...
    public void handleTag() {
        ...
        if (httpCallback != null) {
            httpCallback.setTag(Utils.isEmpty(tag) ? String.valueOf(System.currentTimeMillis()) : tag);
        }
    }
    ...
    private void doUpload() {
        ...
        /*请求处理*/
        String url = Utils.isEmpty(apiUrl) ? "" : apiUrl;
    ...
    private Observable disposeApiObservable(Retrofit retrofit) {
        /*是否JSON格式提交参数*/
        boolean hasBodyString = Utils.isNotEmpty(bodyString);
