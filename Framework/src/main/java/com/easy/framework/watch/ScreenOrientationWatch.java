 ...
 * 屏幕方向监听
 */
public class ScreenOrientationWatch {
    ...
    public ScreenOrientationWatch(Context context) {
    ...
    public void startWatch() {
        Log.d("ScreenOrientationWatch", "startWatch");
        if (mLandOrientationListener == null) {
            mLandOrientationListener = new OrientationEventListener(mContext, SensorManager.SENSOR_DELAY_NORMAL) {
                ...
                public void onOrientationChanged(int orientation) {
                    ...
                    if (isLand) {//横屏
                        if (mOrientationListener != null && (orientation < 100)) {
                            Log.d("ScreenOrientationWatch", "横屏正向");
                            ...
                            Log.d("ScreenOrientationWatch", "横屏反向");
                        ...
                        if (mOrientationListener != null) {
                            Log.d("ScreenOrientationWatch", "竖屏");
    ...
    public void stopWatch() {
        Log.e("ScreenOrientationWatch", "stopWatch");
        if (mLandOrientationListener != null) {
     ...
     */
    public void destroy() {
        Log.e("ScreenOrientationWatch", "onDestroy");
        stopWatch();
