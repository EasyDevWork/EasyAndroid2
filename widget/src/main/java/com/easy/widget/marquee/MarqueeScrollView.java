package com.easy.widget.marquee;
...
public class MarqueeScrollView extends HorizontalScrollView implements Runnable {
    ...
    public MarqueeScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    void initView() {
        ...
        mainLayout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.marquee_scroll_view, null);
        marqueeTextView = mainLayout.findViewById(R.id.marqueeTextView);
    ...
    public void setText(Spanned fromHtml) {
        if (marqueeTextView != null) {
            marqueeTextView.setText(fromHtml);
        }
    }
}