...
import com.easy.loadimage.utils.Utils;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

public class ImageLoadCircleProgressView extends ProgressBar {
    ...
    public ImageLoadCircleProgressView(Context context) {
        this(context, null);
    }

    public ImageLoadCircleProgressView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageLoadCircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
